...
\subsection{Overview}
Build a \textbf{web-based} ERP platform, \textbf{Vyapari}, that unifies the core operational and administrative functions a retail or wholesale business needs to run online:
\begin{itemize}[leftmargin=0.7cm]
